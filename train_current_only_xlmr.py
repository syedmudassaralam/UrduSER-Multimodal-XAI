...
class CFG:
    ...
    SAVE_DIR: str = "./saved_models_text_shared_current_only_5seed_FIXED_7class"
    ...
    TENSORBOARD_DIR: str = "./runs/text_shared_current_only_5seed_FIXED_7class"
